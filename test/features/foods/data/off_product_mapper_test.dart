...
void main() {
  group('OffProductMapper', () {
    ...
    off.Nutriments _nutriments({double? energy, double? proteins}) =>
        off.Nutriments.fromJson({
          if (energy != null) 'energy-kcal_100g': energy,
          if (proteins != null) 'proteins_100g': proteins,
        });
    ...
    test('handles product with no nutriments', () {
      final product = _product(nutriments: null);
    ...
    test('handles product with partial nutriments', () {
      final nutriments = _nutriments(energy: 100);
      final product = _product(nutriments: nutriments);
