...
$NutrientsCopyWith<$Res>? get dailyTarget;
...
@pragma('vm:prefer-inline')
$NutrientsCopyWith<$Res>? get dailyTarget {
    if (_self.dailyTarget == null) {
    return null;
  }

  return $NutrientsCopyWith<$Res>(_self.dailyTarget!, (value) {
    return _then(_self.copyWith(dailyTarget: value));
  });
}
}
...
@override $NutrientsCopyWith<$Res>? get dailyTarget;
