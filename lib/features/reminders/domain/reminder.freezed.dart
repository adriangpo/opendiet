...
mixin _$Reminder {
 ...
 String get id; int get hour; int get minute; bool get enabled; String? get mealSlotId;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Reminder&&(identical(other.id, id) || other.id == id)&&(identical(other.hour, hour) || other.hour == hour)&&(identical(other.minute, minute) || other.minute == minute)&&(identical(other.enabled, enabled) || other.enabled == enabled)&&(identical(other.mealSlotId, mealSlotId) || other.mealSlotId == mealSlotId));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,hour,minute,enabled,mealSlotId);

@override
String toString() {
  return 'Reminder(id: $id, hour: $hour, minute: $minute, enabled: $enabled, mealSlotId: $mealSlotId)';
}
...
@useResult
$Res call({
 String id, int hour, int minute, bool enabled, String? mealSlotId
});
...
/// Create a copy of Reminder
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? hour = null,Object? minute = null,Object? enabled = null,Object? mealSlotId = freezed,}) {
...
as bool,mealSlotId: freezed == mealSlotId ? _self.mealSlotId : mealSlotId // ignore: cast_nullable_to_non_nullable
as String?,
  ));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  int hour,  int minute,  bool enabled,  String? mealSlotId)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Reminder() when $default != null:
return $default(_that.id,_that.hour,_that.minute,_that.enabled,_that.mealSlotId);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  int hour,  int minute,  bool enabled,  String? mealSlotId)  $default,) {final _that = this;
switch (_that) {
case _Reminder():
return $default(_that.id,_that.hour,_that.minute,_that.enabled,_that.mealSlotId);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  int hour,  int minute,  bool enabled,  String? mealSlotId)?  $default,) {final _that = this;
switch (_that) {
case _Reminder() when $default != null:
return $default(_that.id,_that.hour,_that.minute,_that.enabled,_that.mealSlotId);case _:
  return null;
...
class _Reminder implements Reminder {
  const _Reminder({required this.id, required this.hour, required this.minute, required this.enabled, this.mealSlotId});
...
/// Create a copy of Reminder
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? hour = null,Object? minute = null,Object? enabled = null,Object? mealSlotId = freezed,}) {
