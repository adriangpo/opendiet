...
mixin _$Quantity {
 ...
 double get amount; QuantityMeasure get measure;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Quantity&&(identical(other.amount, amount) || other.amount == amount)&&(identical(other.measure, measure) || other.measure == measure));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,amount,measure);
...
@useResult
$Res call({
 double amount, QuantityMeasure measure
});
...
/// Create a copy of Quantity
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? amount = null,Object? measure = null,}) {
  return _then(_self.copyWith(
amount: null == amount ? _self.amount : amount // ignore: cast_nullable_to_non_nullable
as double,measure: null == measure ? _self.measure : measure // ignore: cast_nullable_to_non_nullable
as QuantityMeasure,
  ));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( double amount,  QuantityMeasure measure)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Quantity() when $default != null:
return $default(_that.amount,_that.measure);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( double amount,  QuantityMeasure measure)  $default,) {final _that = this;
switch (_that) {
case _Quantity():
return $default(_that.amount,_that.measure);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( double amount,  QuantityMeasure measure)?  $default,) {final _that = this;
switch (_that) {
case _Quantity() when $default != null:
return $default(_that.amount,_that.measure);case _:
  return null;
...
class _Quantity extends Quantity {
  const _Quantity({required this.amount, required this.measure}): super._();
  factory _Quantity.fromJson(Map<String, dynamic> json) => _$QuantityFromJson(json);

@override final  double amount;
@override final  QuantityMeasure measure;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Quantity&&(identical(other.amount, amount) || other.amount == amount)&&(identical(other.measure, measure) || other.measure == measure));
}
...
/// Create a copy of Quantity
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? amount = null,Object? measure = null,}) {
